// Deterministic Hardhat accounts (default mnemonic). Matches `yarn hardhat node` output
// so the burner wallet can be seeded with a pre-funded key and the dev-wallet switcher
...
// Dev wallet personas — cypherpunk pioneers, Ethereum leaders, and the author.
// Name changes here flow through DevWalletSwitcher and anywhere HardhatAccount.name is shown.
