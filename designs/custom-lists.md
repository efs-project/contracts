...
**Status:** Landed (PR #20) — **frozen design exploration; not maintained and may drift from the implementation.** Canonical decision: **ADR-0044 + ADR-0046** (`docs/adr/`). Current behavior: `specs/06-Lists-and-Collections.md`, `specs/02-Data-Models-and-Schemas.md`. Read the ADRs + specs for truth; this doc is preserved for the "why" and mechanical detail, with round-by-round history in [`custom-lists_notes.md`](./custom-lists_notes.md).
_(Historical drafting status at land: round 18d — schema field strings GO from all three confirmation reviewers; ListReader typed-accessor ABI hardened; schema freeze-ready; reader contract Durable/redeployable.)_
**Date:** 2026-05-28
