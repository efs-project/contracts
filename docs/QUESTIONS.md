...
> **For agents:** see `AGENTS.md` for the escalation tier system. Tier 1 questions belong in chat (blocking). Tier 2 questions belong here AND in chat. Tier 3 small notes belong here without chat.
