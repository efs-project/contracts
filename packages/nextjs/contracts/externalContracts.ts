...
const externalContracts = {
  31337: {
    ...
    EIP712Proxy: {
      ...
      args: ["0xC2679fBD37d54388Ce493F1DB75320D236e1815e", "EIP712Proxy"],
      numDeployments: 2,
      ...
      userdoc: {
        ...
        notice:
          "This utility contract an be used to aggregate delegated attestations without requiring a specific order via     nonces. The contract doesn't request nonces and implements replay protection by storing ***immalleable***     signatures.",
        version: 1,
      },
      storageLayout: {
        storage: [
    ...
    OldIndexer: {
      ...
      userdoc: {
        ...
        methods: {
          ...
          "getReceivedAttestationUIDCount(address,bytes32)": {
            notice:
              "Returns the total number of attestations to a specific schema which were attested to/received by a     specific recipient.",
          },
          "getReceivedAttestationUIDs(address,bytes32,uint256,uint256,bool)": {
            notice:
              "Returns the UIDs of attestations to a specific schema which were attested to/received by a specific     recipient.",
          },
          "getSchemaAttestationUIDCount(bytes32)": {
            notice: "Returns the total number of attestations to a specific schema.",
          },
          ...
          "getSchemaAttesterRecipientAttestationUIDCount(bytes32,address,address)": {
            notice:
              "Returns the total number of UIDs of attestations to a specific schema which were attested by a specific     attester to a specific recipient.",
          },
          "getSchemaAttesterRecipientAttestationUIDs(bytes32,address,address,uint256,uint256,bool)": {
            notice:
              "Returns the UIDs of attestations to a specific schema which were attested by a specific attester to a     specific recipient.",
          },
          "getSentAttestationUIDCount(address,bytes32)": {
            notice:
              "Returns the total number of attestations to a specific schema which were attested by a specific attester.",
          },
          "getSentAttestationUIDs(address,bytes32,uint256,uint256,bool)": {
            notice: "Returns the UIDs of attestations to a specific schema which were attested by a specific attester.",
          },
...
const externalContractsAllChains = {
  ...
  // 26001993 = the EFS devnet (ADR-0062), a Sepolia fork with identical addresses to 31337, so it
  // reuses the same external ABIs/addresses. Required so these chain-agnostic debug-UI contracts stay
  // in the cross-chain `ContractName` intersection now that 26001993 is a target network.
  26001993: externalContracts[31337],
