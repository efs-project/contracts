...
// generateStaticParams: dummy shell so Next.js static export can emit the route.
// Real UID is read at runtime from usePathname() per ADR-0040.
...
export default function ListDetailPage() {
  ...
  const listUID = pathname?.split("/").pop() as `0x${string}` | undefined;
