...
**Status:** Accepted (LIST_ENTRY schema shape partly revised by [ADR-0046](./0046-list-entry-pure-identity-order-as-property.md) — the `int256 weight` field/§4 inline-weight/§6 event field/§7 reorder guidance; LIST `maxEntries` widened `uint32`→`uint256` by [ADR-0047](./0047-widen-list-maxentries-to-uint256.md); the rest of this ADR remains in force)
**Date:** 2026-05-28
