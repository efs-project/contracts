...
- **Inherited / system content**: revoke removes only *your* edges. To delete inherited or `system`-lens content from your own view, you need an additive WHITEOUT on the Anchor/DATA (ADR-0055, post-freeze) — a negative terminal in the lens scan. Not available today; a lens cannot currently suppress content it doesn't own.
