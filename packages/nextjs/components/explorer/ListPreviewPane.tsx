...
export const ListPreviewPane = ({ uid, name, attester: listAttester, onClose, connectedAddress }: Props) => {
  ...
  return (
    <div className="preview-pane absolute inset-0 z-10 max-lg:bg-base-200 lg:static lg:w-[min(52vw,760px)] lg:flex-shrink-0 flex flex-col overflow-hidden border-l border-base-300 bg-gradient-to-b from-base-100 to-base-200/40">
      {/* Header */}
