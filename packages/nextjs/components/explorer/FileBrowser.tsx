  ...
  return (
    <div className="relative h-full flex flex-row">
      ...
      {selectedFile && !previewFullscreen && (
        <div className="preview-pane absolute inset-0 z-10 max-lg:bg-base-200 lg:static lg:w-[min(52vw,800px)] lg:flex-shrink-0 border-l border-base-300 flex flex-col overflow-hidden">
